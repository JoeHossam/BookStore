  ...
  <table class="table table-striped table-dark">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <?php echo $selected["authorDesc"]; ?>
        </td>
        <td class="text-center"><a name="delete" href="/BeyondWords/assets/admin/author/listAuthors.php?delete=<?php echo$selected["id"]; ?>"class="btn btn-danger" onclick="return confirm('Would you like to delete author <?php echo $selected['authorName']; ?> with ID &rdquo;<?php echo $selected['id']; ?>&rdquo; (This action cannot be reversed)')">Delete</a></td>
