...
<div class="container col-4 mt-5">
  ...
  <form method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control mt-2" value="<?php echo $ISBN;?>" name="ISBN" id="ISBN" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <option selected="true" value=<?php echo $authorRow["authID"]; ?>><?php echo $authorRow["authorName"];?></option>
    ...
    <div class="form-group">
      ...
      <option selected="true" value=<?php echo $catRow["catID"]; ?>><?php echo $catRow["catName"];?></option>
